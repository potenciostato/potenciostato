...
#define HP					3
#define CANT_FCI 			8
#define CANT_FCI_PB 		3
#define CANT_FCS 			8
#define CANT_FCS_PB 		3
#define CANT_BP				9
...
#define T_TECLAS			20
#define FREC_TECLAS         1/T_TECLAS
#define T_FORMAONDA			20
#define FREC_FORMAONDA      1/T_FORMAONDA
