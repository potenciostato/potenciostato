...
example/src/%.o: ../example/src/%.c
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M3 -I"C:\workspaceLPC\Sinte\lpc_chip_175x_6x\inc" -I"C:\workspaceLPC\Sinte\lpc_chip_175x_6x\inc\usbd" -I"C:\workspaceLPC\Sinte\lpc_board_nxp_lpcxpresso_1769\inc" -I"C:\workspaceLPC\Sinte\CMSIS_DSPLIB_CM3\inc" -I"C:\workspaceLPC\Sinte\Sintetizador_v1.0\example\inc" -I"C:\workspaceLPC\Sinte\Sintetizador_v1.0\freertos\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
