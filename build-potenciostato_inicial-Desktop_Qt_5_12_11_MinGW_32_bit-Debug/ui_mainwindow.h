...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Num_deltaY->setGeometry(QRect(460, 20, 51, 20));
        ...
        Num_deltaZ->setGeometry(QRect(560, 20, 51, 20));
